...
2. [😬 The Problem With "Typical" sqlquerypilot](#2-the-problem-with-typical-sqlquerypilot)
...
## 2. 😬 The Problem With "Typical" sqlquerypilot

When someone first tries to build a sqlquerypilot system, the obvious approach is usually:
...
```bash
git clone https://github.com/nerdjerry/sqlquerypilot.git
cd sqlquerypilot
